...
public class TestDb extends AndroidTestCase {
    ...
    */
    ...
    public void testWeatherTable() {
        ...
        // query if you like)
        TestUtilities.validateCurrentRecord("testInsertReadDb weatherEntry failed to validate", c, testValues);
    ...
    public long insertLocation() {
        ...
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCurrentRecord("CURSOR not working", c, testValues);
        assertFalse("error: more than one recor returned from loc query", c.moveToNext());
        // Finally, close the cursor and database
        c.close();
        db.close();
